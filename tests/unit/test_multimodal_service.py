...
class TestMultimodalService(unittest.TestCase):
    ...
    def test_generate_response_with_base64_image(self, mock_genai):
        ...
        with patch.dict(os.environ, {'GEMINI_API_KEY': 'test-key'}):
            ...
            self.assertEqual(call_args[1]["inline_data"]["mime_type"], "image/jpeg") # Default mime type for base64
    ...
    @patch('app.services.multimodal_service.genai')
    def test_generate_response_with_image_path(self, mock_genai, mock_file, mock_exists):
        ...
        with patch.dict(os.environ, {'GEMINI_API_KEY': 'test-key'}):
            ...
            response = service.generate_response("Analyze this image.", images=[image_path])
            ...
            self.assertEqual(base64.b64decode(call_args[1]["inline_data"]["data"]), b'imagedata')

    @patch('app.services.multimodal_service.os.path.exists', return_value=False)
    @patch('app.services.multimodal_service.genai')
    def test_generate_response_with_nonexistent_image_path(self, mock_genai, mock_exists):
    ...
    def test_get_multimodal_service_singleton(self, mock_genai):
        ...
        with patch.dict(os.environ, {'GEMINI_API_KEY': 'test-key'}):
            ...
            with patch('app.services.multimodal_service._multimodal_service_instance', None):
