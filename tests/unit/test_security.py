...
@pytest.mark.parametrize("request_data, expected_threats", [
...
@pytest.mark.skipif(not DataEncryption(password="test").key, reason="cryptography library not available or failed to init")
