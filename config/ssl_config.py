...
class SSLConfig:
    ...
    def create_ssl_certificates(self, force_recreate=False):
        ...
        # Si ya existen los certificados y no se fuerza recreación, no
        # regenerar
    ...
    def validate_certificates(self):
        ...
        try:
            ...
            if (cert.not_valid_after_utc.replace(tzinfo=None) - now).days < 30:
                return True, f"Certificado expira en {
                    (
                        cert.not_valid_after_utc.replace(
                            tzinfo=None) - now).days} días"
...
def create_ssl_certificates():
    ...
    try:
        ...
        cmd = [
            ...
            '-nodes',
            '-subj',
            '/C=ES/ST=Madrid/L=Madrid/O=GeminiAI/OU=Development/CN=localhost']
