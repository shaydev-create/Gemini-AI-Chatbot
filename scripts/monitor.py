            ...
            with self.app.app_context():
                metrics = {
                    ...
                    "sessions": {
                        ...
                        "active": ChatSession.query.filter_by(status='active').count()
                    },
                    "system": {
    ...
    def monitor_continuously(self, interval: int = 300):
        ...
        try:
            while True:
                ...
                logger.info(f"📊 Health checks: {healthy_count}/{total_count} healthy")
...
def main():
    ...
    parser.add_argument('--interval', type=int, default=300, help='Intervalo en segundos para monitoreo continuo')
