...
FILES_TO_REMOVE = [
    ...
    "scripts/create_icons.py",  # Reemplazado por create_chrome_icons.py y create_futuristic_icons.py
]
...
def main():
    ...
    parser.add_argument("--dry-run", action="store_true", help="Mostrar qué se eliminaría sin realizar cambios")
