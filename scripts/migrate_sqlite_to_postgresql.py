...
def get_postgresql_connection(db_config: Dict[str, str]) -> psycopg2.extensions.connection:
...
def create_postgresql_table(pg_conn: psycopg2.extensions.connection, table_name: str, schema: List[Tuple[str, str]]) -> bool:
...
def migrate_table_data(sqlite_conn: sqlite3.Connection, pg_conn: psycopg2.extensions.connection, table_name: str) -> bool:
...
def verify_migration(sqlite_conn: sqlite3.Connection, pg_conn: psycopg2.extensions.connection, table_name: str) -> bool:
