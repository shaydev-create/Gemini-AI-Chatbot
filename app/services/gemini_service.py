...
class GeminiService:
    ...
    def generate_response(self, message: str = None, session_id: str = None, user_id: int = None, prompt: str = None, image_data: str = None, language: str = "es") -> str:
        """
